...
public class nHelper {
    ...
    public static void play(String argv[]) throws Exception {
        ...
        if (player1 == 1) {
            ...
            p1writer.write(boardToString(board));
            ...
            p2writer.write(boardToString(board));
    ...
    // public static List<Integer> convolve(char[][] board){
    ...
    public static double getPrediction(State state){
        double[] thisBoard = boardToDoubleArray(state.board);
        List<Double> predict = myNet.predict(thisBoard);
